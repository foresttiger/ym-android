...
class Item extends Component {
  ...
  render(){
    const { jobId,name,panoramaUrl } = this.props.data
    let obj = {
      name:name,
      jobId:jobId,
          ...
          <View style={styles.scrollViewStyle}>
            {
              this.state.data.map((item, i) => {
                return <Item key={i} data={{"jobId":item.productId,"panoramaUrl":item.panoramaUrl,"name":item.productName,"nav":_this.props.props}} />
              })
            }
          </View>
         </ScrollView>
