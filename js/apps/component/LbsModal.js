        ...
        <ScrollView style={styles.scrollView}>
          ...
          <View style={styles.address}>
            ...
            <View style={{flexDirection: "row", alignItems: "center"}}>
              {this.state.loading?<ActivityIndicator style={styles.aior}/>:<Icon name="ios-locate-outline" size={22} color="#038de1" />}
              <Text style={{color: "#038de1", fontSize: px2dp(13), marginLeft: 5}}>{"重新定位"}</Text>
            </View>
            </TouchableOpacity>
          </View>
